...
if __name__ == "__main__":
    ...
    lang = get_lang(train_raw, dev_raw, test_raw, y_train, y_dev, y_test)
    ...
    f1_bidir, intent_acc_bidir = eval_f1_acc(lang, train_loader, dev_loader, test_loader, 0)
    
    f1_dropout, intent_acc_dropout = eval_f1_acc(lang, train_loader, dev_loader, test_loader, 1)
